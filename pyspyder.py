...
# https://microsoft.webhook.office.com/webhookb2/577208ca-2378-4222-a0d6-a5297dfec8a5@72f988bf-86f1-41af-91ab-2d7cd011db47/IncomingWebhook/9fbfe62c01854eabaa2250712f1f7a61/6701c303-f6a1-4998-bae1-b64f726f699e
...
class Spyder():
    def __init__(self):
        ...
        self.starttime = datetime.datetime.strptime('2023-10-29T18:24:08Z', '%Y-%m-%dT%H:%M:%SZ')
    ...
    def get_commit_page(self):
        ...
        for item in action:
            ...
            for i in time_:
                a = i['datetime']
                precise_time_list.append(datetime.datetime.strptime(str(a), '%Y-%m-%dT%H:%M:%SZ'))

        action_u = soup.find_all('a', {'class': 'Link--primary text-bold js-navigation-open markdown-title'})
    ...
    def get_change(self, time, url):
        ...
        deleted_list = []
        added_list = []
        deleted = soup.find_all('span', class_='blob-code-inner blob-code-marker js-code-nav-pass js-skip-tagsearch')
        added = soup.find_all('span', {'data-code-marker': '+'})

        with sync_playwright() as p:
            browser = p.chromium.launch(headless=True)
            context = browser.new_context(extra_http_headers=self.headers,user_agent='Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.76')  
            ...
            for i in page.locator("//span[@class='Truncate']//a[@class='Link--primary Truncate-text']").all():
    ...
    def gpt_summary(self, input_dict):
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": """you will get a dict style input ,*You need to make a summary of the deleted operations and the added operations*
